...
# Configuração do tema Altair (escuro)
...
# ====================== DASHBOARD ======================
    ...
    # ── ABA STATS ───────────────────────────────────────────────────────────────
        ...
        if df.empty:
            ...
            with col2:
                st.metric("Melhor Carga", f"{df_chart['peso'].max():.1f} kg")
            with col3:
                st.metric("Progresso Total", f"{df_chart['peso'].max() - df_chart['peso'].min():.1f} kg")
            with col4:
